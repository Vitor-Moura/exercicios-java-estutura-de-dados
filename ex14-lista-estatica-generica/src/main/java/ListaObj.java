public class ListaObj<T> {
    ...
    /* Método que retorna o tammanho da lista*/
    public int getTamanho(){
        return nroElem;
    }

    /* Método que recebe um índice e retorna o elemento*/
    public T getElemento(Integer indiceDigitado){
        if (indiceDigitado < 0 || indiceDigitado >= nroElem){
            return null;
        }
        return vetor[indiceDigitado];
    }
