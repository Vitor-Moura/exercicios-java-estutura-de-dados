public class CameraMan {
    ...
    public CameraMan(int id, String nome, Double valorSalario, Integer qtdHoraExtra,
                     Double valorHoraExtra, Integer qtdProgramas, Double valorValeTransporte, Double valorValeRefeicao) {
        this.id = id;
        this.nome = nome;
    ...
    public String toString() {
        return "CameraMan{" +
                ...
                ", valorValeTrasporte=" + valorValeTransporte +
                ", valorValeRefeicao=" + valorValeRefeicao +
                '}';
    }
}
